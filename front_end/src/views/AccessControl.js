  ...
  render(){
    return (
      <CRow>
        ...
        <CCardBody>
          <ul>
            {this.state.deny_output? this.state.deny_output.map((line, i) => <li key={i}>{line}</li>) : ""}
          </ul>
        </CCardBody>
        </CCard>
        ...
        <CCardBody>
          <ul>
            {this.state.no_deny_output? this.state.no_deny_output.map((line, i) => <li key={i}>{line}</li>) : ""}
          </ul>
        </CCardBody>
        </CCard>
        </CCol>
